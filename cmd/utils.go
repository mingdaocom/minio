...
// Returns context with ReqInfo details set in the context.
func MingdaoNewContext(r *http.Request, w http.ResponseWriter, api string) context.Context {
	vars := mux.Vars(r)
	bucket := vars["bucket"]
	object := vars["object"]
	prefix := vars["prefix"]
	...
	return logger.SetMingdaoReqInfo(context.Background(), reqInfo)
}
