      ...
      <li>
        <Dropdown pullRight id="top-right-menu">
          ...
          <Dropdown.Menu className="dropdown-menu-right">
            <li>
              <a target="_blank" href="https://www.mingdao.com">
                明道 <i className="fab fa-github" />
              </a>
            </li>
            <li>
              <a href="" onClick={this.fullScreen}>
                全屏 <i className="fas fa-expand" />
              </a>
            </li>
            <li>
              <a href="" id="show-about" onClick={this.showAbout.bind(this)}>
                系统信息 <i className="fas fa-info-circle" />
              </a>
            ...
            <li>
              <a href="" id="logout" onClick={this.logout}>
                登出 <i className="fas fa-sign-out-alt" />
              </a>
            </li>
          </Dropdown.Menu>
        </Dropdown>
